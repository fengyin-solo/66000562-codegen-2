<template>
  <div class="panel">
    <h4>📜 执行日志</h4>
    <div class="log-list">
      <div v-for="(l, i) in logs" :key="`${l.timestamp}-${i}`" class="log-row" :class="l.status.toLowerCase()">
...
.log-row.warning{color:#fbbf24;background:#f59e0b10}.log-row.queued{color:#93c5fd;background:#3b82f610}
.log-row.circuit_open{color:#f87171;background:#ef444410}
.l-status{font-weight:700;min-width:42px}.l-task{color:#888;min-width:70px}.l-msg{color:#ccc}.empty{color:#4a5568}
</style>
